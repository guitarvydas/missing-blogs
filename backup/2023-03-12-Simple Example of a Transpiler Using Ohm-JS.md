# 2023-03-12-Simple Example of a Transpiler Using Ohm-JS# Simple Example of a Transpiler Using Ohm-JS
- [Goal:](#goal)
- [Code in Ohm-JS](#code-in-ohm-js)
- [\_terminal()](#-terminal)
- [\_iter()](#-iter)
- [Hacking the Example to Transpile to Python Instead of JavaScript](#hacking-the-example-to-transpile-to-python-instead-of-javascript)
- [Hacking the Example to Transpile to WASM Instead of JavaScript and Python](#hacking-the-example-to-transpile-to-wasm-instead-of-javascript-and-python)
