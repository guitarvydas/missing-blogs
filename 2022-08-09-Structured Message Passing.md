...
!![Message Passing vs CALL RETURN.png](images/Message Passing vs CALL RETURN_14.png)
...
## Example
### Lamp
!![wip-original/attic/state explosion-Lamp.png](images/state explosion-Lamp_14.png)


### State Explosion

!![wip-original/attic/state explosion-State Explosion.png](images/state explosion-State Explosion_14.png)
...
!![wip-original/attic/state explosion-HSM - Hierarchical State Machine.png](images/state explosion-HSM - Hierarchical State Machine_14.png)
...
!![structured message passing.png](images/structured message passing_28.png)
