...
# Fire And Forget
!![fireandforget-fire-and-forget.png](fireandforget-fire-and-forget_62.png)
[2022-06-04-Fire and Forget](#2022-06-04-fire-and-forget)

# Simultaneity
!![fireandforget-simultaneity.png](fireandforget-simultaneity_62.png)

# Faking Multitasking on 1 CPU
!![fireandforget-faking-on-1-cpu.png](fireandforget-faking-on-1-cpu_62.png)
# Anti 0D
Tools that appease the use of dependencies instead of addressing the fundamental problem (getting rid of dependencies).
!![fireandforget-anti-0D.png](fireandforget-anti-0D_62.png)
# Execution
!![fireandforget-execution.png](fireandforget-execution_62.png)
# Operating System Processes
!![fireandforget-operating-system-processes.png](fireandforget-operating-system-processes_62.png)
# Multiple Single CPUs
!![fireandforget-multiple-single-cpus.png](fireandforget-multiple-single-cpus_62.png)iple Single CPUs

# Closures
!![fireandforget-closures.png](fireandforget-closures_62.png)
