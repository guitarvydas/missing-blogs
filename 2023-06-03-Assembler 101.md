...
## Data Shapes
### int
![DrawIO/odin data shapes-int.drawio.png](images/odin data shapes-int.drawio.png)
### slice
![DrawIO/odin data shapes-slice.drawio.png](images/odin data shapes-slice.drawio.png)
### string
![DrawIO/odin data shapes-string.drawio.png](images/odin data shapes-string.drawio.png)
### any
![DrawIO/odin data shapes-any.drawio.png](images/odin data shapes-any.drawio.png)
