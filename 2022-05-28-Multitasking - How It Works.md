# 2022-05-28-Multitasking - How It Works---
tags:
- graphicessay
- concurrency
---
...
!![multitasking-steady-state.png](multitasking-steady-state_16.png)
...
!![multitasking-context-switch-step-1.png](multitasking-context-switch-step-1_16.png)
## 2. Context Switch Step 2

In step 2, we restore the state of *process B*, by overwriting CPU registers (etc.).

!![multitasking-context-switch-step-2.png](multitasking-context-switch-step-2_16.png)
...
!![multitasking-context-switch-step-3.png](multitasking-context-switch-step-3_16.png)
