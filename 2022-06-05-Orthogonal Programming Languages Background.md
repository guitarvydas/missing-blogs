# 2022-06-05-Orthogonal Programming Languages BackgroundCordy discussed the concept of Orthogonal Code Generators for compilers in his thesis. The concept is to cleanly separate *operations* from *operands*.  This separation made it much easier to compile code sequences to other languages (in this particular case, the other languages were *assemblers* for various CPUs).
